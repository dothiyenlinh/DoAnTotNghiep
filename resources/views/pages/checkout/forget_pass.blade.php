                                        ...
                                        <tbody>
                                            <form action="{{url('/recover-pass')}}" method="POST">
                                                ...
                                                <tr>
                                                    <td style="padding-top: 48px; padding-bottom: 48px;">
                                                        <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                            <tbody>
                                                                <tr>
                                                                    <input style="width: 100%; height: 25px;" placeholder="your_email@gmail.com" name="email_account" type="text"></input>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    {{__('Bạn nhận được e-mail này vì bạn đã yêu cầu đặt lại mật khẩu cho tài khoản của mình.')}}
                                                    </td>
                                                </tr>
                                                <tr>
